    ...
    <table class="mt-10">
        <tr>
            <td style="font-size:10px;">
                ...
                Catatan I : Pada saat Manager Operasi sudah tanda tangan dan berkeyakinan penuh maka PCC harus
                mengalokasikan pada RPUM dan Form PPJB tetap di routing QA dan Direksi.<br>
